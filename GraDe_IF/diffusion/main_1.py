...
pdb_folder = "../../../Data/DESRES-Trajectory_sarscov2-15235449-peptide-A-no-water-no-ion/sarscov2-15235449-peptide-A-no-water-no-ion/sarscov2-15235449-peptide-A-no-water-no-ion-0000-pdbs"
pdb_max_idx = 2
sample_num = 50
...
D = 1 - recovery_rate_matrix[:sample_num, sample_num:]
import ot 
